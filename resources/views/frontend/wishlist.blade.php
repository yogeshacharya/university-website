...
<!-- Mirrored from template.hasthemes.com/edubuzz/edubuzz/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 18:25:52 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Wishlist || Edubuzz</title>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="edubuzz-product-stock-status">Stock Status</th>
                                                    <th class="edubuzz-product-add-cart">add to cart</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="edubuzz-product-name"><a href="#">Nullam maximus</a></td>
                                                    <td class="edubuzz-product-price"><span class="amount">$23.39</span></td>
                                                    <td class="edubuzz-product-stock-status"><span class="in-stock">in stock</span></td>
                                                    <td class="edubuzz-product-add-cart"><a href="#">add to cart</a></td>
                                                </tr>
                                                <tr>
                                                    <td class="edubuzz-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                    <td class="edubuzz-product-thumbnail"><a href="#"><img src="img/cart/cart2.jpg" alt=""></a></td>
                                                    <td class="edubuzz-product-name"><a href="#">Natus erro</a></td>
                                                    <td class="edubuzz-product-price"><span class="amount">$30.50</span></td>
                                                    <td class="edubuzz-product-stock-status"><span class="in-stock">in stock</span></td>
                                                    <td class="edubuzz-product-add-cart"><a href="#">add to cart</a></td>
                                                </tr>
                                                <tr>
                                                    <td class="edubuzz-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                                    <td class="edubuzz-product-thumbnail"><a href="#"><img src="img/cart/cart3.jpg" alt=""></a></td>
                                                    <td class="edubuzz-product-name"><a href="#">Sit voluptatem</a></td>
                                                    <td class="edubuzz-product-price"><span class="amount">$40.19</span></td>
                                                    <td class="edubuzz-product-stock-status"><span class="out-stock">out stock</span></td>
                                                    <td class="edubuzz-product-add-cart"><a href="#">add to cart</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
