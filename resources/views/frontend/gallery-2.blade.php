...
<!-- Mirrored from template.hasthemes.com/edubuzz/edubuzz/gallery-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jan 2022 18:25:38 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Gallery Style Two || Edubuzz</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="breadcrumb-text">
                                    <h1 class="text-center">Gallery Style Two</h1>
                                    <div class="breadcrumb-bar">
                                        <ul class="breadcrumb text-center">
                                            <li><a href="index.html">Home</a></li>
                                            <li>Gallery Style Two</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">
                       <div class="row">
                        ...
                        <div class="row masonry__wrap">
                            ...
                            <div class="col-md-4 gallery__item" style="position: absolute; left: 0%; top: 0px;"></div>
                            <!--Single Gallery Image Start-->
                            <div class="col-md-4 col-sm-6 gallery__item cat--1">
                            ...
                            <!--Single Gallery Image Start-->
                            <div class="col-md-4 col-sm-6 gallery__item cat--2">
                                <div class="single-gallery-img mb-30">
                            ...
                            <!--Single Gallery Image End-->
                            <!--Single Gallery Image Start-->
                            <div class="col-md-4 col-sm-6 gallery__item cat--3 cat--2">
                                <div class="single-gallery-img mb-30">
                            ...
                            <!--Single Gallery Image End-->
                            <!--Single Gallery Image Start-->
                            <div class="col-md-4 col-sm-6 gallery__item cat--3">
                                <div class="single-gallery-img mb-30">
                            ...
                            <!--Single Gallery Image End-->
                            <!--Single Gallery Image Start-->
                            <div class="col-md-4 col-sm-6 gallery__item cat--3 cat--2 cat--1">
                                <div class="single-gallery-img mb-30">
                            ...
                            <!--Single Gallery Image End-->
                            <!--Single Gallery Image Start-->
                            <div class="col-md-4 col-sm-6 gallery__item cat--3 cat--1">
                                <div class="single-gallery-img mb-30">
